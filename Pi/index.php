...
<body>
    ...
    <section class="box">
        <h2>Bem vindo <?php echo $_SESSION['Email'];?></h4><br>
        ...
        <main class="mini">   
            ...
            <div class="options"><a href="unidades.html"><img src="img/hospital.png" width="35%" alt=""><h1>Unidades de saúde mais próximas</h1></a></div>
